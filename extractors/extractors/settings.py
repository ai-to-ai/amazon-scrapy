...
PRODUCT_COLLECTION = settings.products_table
PRODUCT_CATEGORY_COLLECTION = settings.products_category_table
PRODUCT_SELLER_COLLECTION = settings.products_sellers_table
PRODUCT_PRICE_HISTORY_COLLECTION = settings.product_price_history_table
APP_SETTING_COLLECTION = settings.app_settings_table
...
DEFAULT_REQUEST_HEADERS = settings.headers
